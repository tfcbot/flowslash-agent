            ...
            const responseData = {
                sdk: {
                    ...
                    usage: {
                        ...
                        example: `const result = await client.execute.executeTool({ userId: 'user123', toolName: 'GMAIL_SEND_EMAIL', parameters: { to: 'test@example.com', subject: 'Hello', body: 'World' } });`,
                    }
                }
            };
...
const result = await client.execute.executeTool({
  userId: 'user123',
...
//# sourceMappingURL=sdk-simple.js.map